//! vLLM 协议适配器 —— vLLM 是 OpenAI 兼容服务（/v1/chat/completions），
...
#[async_trait]
impl crate::backend_adapters::BackendAdapter for VllmAdapter {
    fn protocol(&self) -> crate::router::ProtocolKind { crate::router::ProtocolKind::Vllm }
